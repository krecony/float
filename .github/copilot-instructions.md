...
Core concept:
Users create temporary travel groups with a shared virtual debit card.
Transactions require multi-person approval before execution.
No balances are held in-app; payments are pay-as-you-go via a processor.

Main demo flow:

1. Users join a travel group
2. Group receives a virtual card
...
6. Transaction status updates live across all devices
